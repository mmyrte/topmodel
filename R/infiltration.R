...
#' @param parameters A vector containing 3 parameters (see Details for the exact structure)
#'
#' @details
...
#' }
#'
#' @return The function returns a vector with the same length as the input vector rain representing infiltration.
#'
